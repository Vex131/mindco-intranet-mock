      ...
      <section className="rounded-[24px] mindco-panel p-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          <div className="flex items-start gap-5">
            <div className="flex h-20 w-20 items-center justify-center rounded-[24px] bg-[linear-gradient(180deg,#7c6cff,#4e7bff)] text-2xl font-semibold text-white">
              N
            </div>
          ...
          <button className="rounded-2xl border border-[rgba(129,157,255,0.14)] bg-white/[0.04] px-4 py-2 text-sm text-white/75">
            Edit Profile
          </button>
        </div>
      ...
      <section className="grid gap-6 xl:grid-cols-[1.4fr_1fr]">
        <div className="rounded-[28px] mindco-panel p-6">
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl bg-[rgba(255,255,255,0.035)] p-4">
          ...
          {uploads.length > 0 ? (
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
              {uploads.map((item, index) => (
                <article
                  key={item.title}
                  className="overflow-hidden rounded-[24px] border border-[rgba(129,157,255,0.14)] bg-[rgba(255,255,255,0.03)]"
                >
